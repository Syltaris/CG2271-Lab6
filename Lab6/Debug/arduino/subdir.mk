...
arduino/WInterrupts.o: C:/Arduino/hardware/arduino/avr/cores/arduino/WInterrupts.c
	...
	avr-gcc -I"C:\Arduino\hardware\arduino\avr\cores\arduino" -I"C:\freeRTOS\Source\include" -Wall -g2 -gstabs -O0 -fpack-struct -fshort-enums -ffunction-sections -fdata-sections -std=gnu99 -funsigned-char -funsigned-bitfields -mmcu=atmega328p -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
